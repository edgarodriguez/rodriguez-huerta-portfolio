...
#let font-text-default = ("Roboto", "Arial", "Helvetica", "Dejavu Sans")
...
#let resume-item(body) = {
  ...
  set list(indent: 1em)
  block(
    above: 0.5em,  // space before the item block
    below: 1em,  // space after the item block
  )[
    #body
  ]
}
...
== Peer reviewed
<peer-reviewed>
- #strong[Rodríguez-Huerta];, E., Bell, B., Jackson, B., Blackstone, N.T., Battaglia, K., Marquez, A.S., Benoît Norris, C., Decker Sparks, J.L., Conrad, Z., Matteson, J. (anticipated 2025). The human cost of current and recommended diets in the U.S. (#emph[accepted for Nature Food];). #link("https://doi.org/10.21203/rs.3.rs-4999594/v1%5D")[`https://doi.org/10.21203/rs.3.rs-4999594/v1`]

- #strong[Rodríguez-Huerta];, E., Leão L., Landman, T. (2025). Climate change, decent work and workers' health in Brazil: theoretical considerations. Revista Brasileira de Saúde Ocupacional #link("https://doi.org/10.1590/2317-6369/16224en2025v50eddsst12")[`https://doi.org/10.1590/2317-6369/16224en2025v50eddsst12`]
...
- Bell, B., Cudhea, F., Battaglia, K., Marquez, A.S., Morris, E., Nelson, J., #strong[Rodríguez-Huerta];, E., Jackson, B., Wang, L., Conrad, Z., Decker Sparks, J.L., Luo, H., Fuller, K., Gao, S., Harney, B., Cash, S., Webb,P., Zhang, F.F.,Blackstone, N.T.(anticipated 2026). Shifting to recommended diets in the US improves health outcomes, but has differing environmental, social, and economic impacts. (#emph[in preparation for Nature Food];).
